...
function Home() {
  ...
  return (
    <>
      <Navbar />
      <div className="Welcome_container min-h-screen flex flex-col">
        <div className="flex-1 max-w-6xl mx-auto py-8 sm:px-6 lg:px-8 relative"> {/* 🔥 Container'ı daralttım ama padding'i arttırdım */}
