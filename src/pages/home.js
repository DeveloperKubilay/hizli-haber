...
// Navbar component integrated directly into home.js
          ...
          <div>
            {currentUser ? (
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  {currentUser.photoURL && !imageError ? (
                    ...
                    <div className="w-8 h-8 rounded-full bg-gray-300 mr-2 flex items-center justify-center text-gray-600">
              ...
              <button
                ...
                className="flex items-center bg-white border border-gray-300 rounded-md shadow-sm px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
              >
